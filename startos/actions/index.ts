...
import { recoverLibraryStorage } from './recoverLibraryStorage'
import { cancelLibraryCopy } from './cancelLibraryCopy'
...
export const actions = sdk.Actions.of()
  ...
  .addAction(recoverLibraryStorage)
  .addAction(cancelLibraryCopy)
