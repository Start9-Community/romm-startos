...
const shape = z.looseObject({
  ...
  igdbClientId: z.string().optional().catch(undefined),
  igdbClientSecret: z.string().optional().catch(undefined),
  mobygamesApiKey: z.string().optional().catch(undefined),
  steamGridDbApiKey: z.string().optional().catch(undefined),
