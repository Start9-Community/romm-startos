...
const dict = {
  ...
  'Library copy failed: ${error}. Original files remain selected. Stop RomM and use Configure Library Storage to retry the same destination, or run Cancel Library Copy.': 103,
  ...
  'Recovery uses the original library at main:library. Later changes in the file manager or newer retained copies are not included.': 107,
  'The retained original library at main:library is selected. Later changes in the file manager or newer retained copies are not included.': 108,
  ...
  'Select the retained original library at main:library without accessing the file manager.': 116,
  'Cancel the queued, interrupted, or failed copy. The current library stays selected.': 118,
